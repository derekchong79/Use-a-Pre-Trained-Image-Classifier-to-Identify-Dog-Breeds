...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        #print("results_dic value = ", results_dic[key])
        ...
        #pet images is not a dog
        if results_dic[key][3] == 0:
            results_stats_dic['n_correct_notdogs'] += 1
            
    #print("n_images count = ", results_stats_dic['n_images'])
    #print("n_dogs_img count = ", results_stats_dic['n_dogs_img'])
    #print("n_match count = ", results_stats_dic['n_match'])
    #print("n_correct_dogs count = ", results_stats_dic['n_correct_dogs'])
    #print("n_correct_notdogs count = ", results_stats_dic['n_correct_notdogs'])
    #print("n_correct_breed count = ", results_stats_dic['n_correct_breed'])  
